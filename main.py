...
class Trainer(object):
    def __init__(self, args):
        ...
        self.val_evaler = Evaler(
            ...
            gtt_feats = cfg.DATA_LOADER.VAL_GTT_FEATS,
        ...
        self.test_evaler = Evaler(
            ...
            gtt_feats = cfg.DATA_LOADER.TEST_GTT_FEATS,
    ...
    def setup_dataset(self):
        self.coco_set = datasets.coco_dataset.CocoDataset(
            ...
            gtt_feats_folder = cfg.DATA_LOADER.TRAIN_GTT_FEATS,
    ...
    def make_kwargs(self, indices, input_seq, target_seq, gv_feat, att_feats, gtt_feats, att_mask):
        ...
        #print(att_feats.shape)  #10, 38, 2048
        #print(gtt_feats.shape)  # 360,4
        #print(gv_feat.shape)   #10, 1
        #exit(0)
        kwargs = {
    ...
    def train(self):
        ...
        for epoch in range(cfg.SOLVER.MAX_EPOCH):
            ...
            losses = AverageMeter()
            for _, (indices, input_seq, target_seq, gv_feat, att_feats, gtt_feats, att_mask) in enumerate(self.training_loader):
                data_time.update(time.time() - start)
                #print(att_feats.shape)   # 10, 38, 2048
                #print(gtt_feats.shape)  # 360, 4
                #print(gv_feat.shape)   # 10, 1
                #exit(0)
                #gtt_feats = gtt_feats.view(10,36, 4)

                input_seq = input_seq.cuda()
                target_seq = target_seq.cuda()
                gv_feat = gv_feat.cuda()
                att_feats = att_feats.cuda()
                gtt_feats = gtt_feats.cuda()

                att_mask = att_mask.cuda()

                kwargs = self.make_kwargs(indices, input_seq, target_seq, gv_feat, att_feats, gtt_feats, att_mask)
